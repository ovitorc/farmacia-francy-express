...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Farmácias Francy | Credibilidade popular" },
      {
        name: "description",
        content:
          "Farmácia de bairro em João Pessoa com medicamentos, higiene e perfumaria. Pedido online finalizado pelo WhatsApp.",
      },
      { name: "author", content: "Farmácias Francy" },
      { property: "og:title", content: "Farmácias Francy | Credibilidade popular" },
      {
        property: "og:description",
        content: "Medicamentos, higiene e perfumaria com preço justo. Peça pelo WhatsApp.",
      },
